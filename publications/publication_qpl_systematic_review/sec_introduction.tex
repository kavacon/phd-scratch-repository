...
That friction manifests in four recurring patterns, each addressed by the evaluation instrument in Section~\ref{sec:evaluation_instrument}.
...
RQ1 is answered empirically in Section~\ref{sec:system_assessments}, through the systematic assessment of eleven quantum programming systems using the evaluation instrument defined in Section~\ref{sec:evaluation_instrument}.
...
This review assesses eleven quantum programming languages and frameworks using an objective instrument, characterising their current abstraction level and identifying where the gap to productive quantum programming lies.
...
\begin{enumerate}
    ...
    \item An evaluation instrument operationalising abstraction level, type system transparency, composability, expressiveness and quantum bias.
    Including a task suite used to ground assessments in concrete programming scenarios based on objective conditions.
    \item An operationalisation of \textit{quantum bias} as an evidence-backed condition applicable to any current or future quantum programming system.
    \item Systematic assessments of eleven quantum programming systems using the instrument, producing comparable profiles and a cross-system analysis of abstraction strengths and deficits.
...
Section~\ref{sec:evaluation_instrument} presents the evaluation instrument and task suite.
...
Section~\ref{sec:system_assessments} applies the instrument to each system, presenting scored profiles and comparative analysis.
