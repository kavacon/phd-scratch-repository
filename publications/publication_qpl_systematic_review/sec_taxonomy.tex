...
Tier assignments are not reported here; they are findings produced by applying the evaluation rubric defined in Section~\ref{sec:evaluation_rubric} and are reported in Section~\ref{sec:language_assessments}.

\begin{table}[htbp*]
    \centering
    \caption{Systems under review. Tier assignments are reported in Section~\ref{sec:language_assessments}, not here.}
    ...
    \begin{threeparttable}
        ...
        \begin{tabular}{ll}
            ...
            \addlinespace
            Quipper~\cite{green2013quipper}\tnote{\dag}       & Embedded circuit framework (historical) \\
            \bottomrule
        \end{tabular}
        \begin{tablenotes}
            \footnotesize
