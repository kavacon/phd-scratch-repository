...
Tier assignments are not reported here; they are findings produced by applying the evaluation rubric defined in Section~\ref{sec:evaluation_instrument} and are reported in Section~\ref{sec:system_assessments}.
