...
\begin{itemize}
    ...
    \item The systematic review methodology that underpins Section~\ref{sec:methodology} and Section~\ref{sec:system_assessments}.
\end{itemize}
...
A survey of 251 active quantum programmers found that 86\% hold five or more years of classical programming experience, yet the dominant reported challenge was not a gap in programming competence but in quantum-mechanical vocabulary~\cite{ferreira2024qplusage}.
