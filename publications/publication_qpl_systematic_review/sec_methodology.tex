...
Results are reported in Section~\ref{sec:language_assessments}.
...
\begin{description}
    \item[C\textsubscript{1}] A formal specification or peer-reviewed primary paper exists.
    \item[C\textsubscript{2}] Active releases or specification updates within 24 months prior to the cutoff.
    \item[C\textsubscript{3}] Multivendor or multi-device backend support beyond a single lab or vendor.
    \item[C\textsubscript{4}] Public documentation is sufficient to complete tasks defined in Section~\ref{subsec:evaluation_rubric:task_suite} without access to private knowledge.
\end{description}
