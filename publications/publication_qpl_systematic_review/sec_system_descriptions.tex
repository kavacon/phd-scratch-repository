...
The eleven systems surveyed were selected according to criteria C\textsubscript{1}--C\textsubscript{4} defined in Section~\ref{sec:taxonomy} and the inclusion/exclusion protocol described in Section~\ref{sec:methodology}.
...
Quipper does not satisfy inclusion criteria C\textsubscript{2} and C\textsubscript{3} (Sections~\ref{sec:taxonomy}and~\ref{sec:methodology}) and is excluded from primary assessment in Section~\ref{sec:system_assessments}.
