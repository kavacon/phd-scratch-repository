...
Quipper is described in Subsection~\ref{subsec:system_descriptions:quipper} but does not satisfy inclusion criteria C\textsubscript{2} and C\textsubscript{3}.
...
They are retained as comparison cases for the non-Python embedded DSL tradition and data model abstraction and excluded from primary assessment in Section~\ref{sec:system_assessments}.
