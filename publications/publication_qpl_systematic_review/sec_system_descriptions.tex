...
Quipper does not satisfy inclusion criteria C\textsubscript{2} and C\textsubscript{3} (Sections~\ref{sec:pub_qpl_review:taxonomy}and~\ref{sec:pub_qpl_review:review_methodology}) and is excluded from primary assessment in Section~\ref{sec:pub_qpl_review:system_assessments}.
