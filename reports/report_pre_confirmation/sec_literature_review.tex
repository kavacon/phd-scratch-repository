...
Table~\ref{tab:lit_rev:criteria_violations} assesses the three most advanced high-level languages against four criteria governing the programming layer~\cite{nunez_corrales2025betterabstractmachines}.
...
\begin{table}[ht!]
    ...
    \label{tab:lit_rev:criteria_violations}
    \small
