...
Despite genuine progress in the development of high-level quantum programming languages (QPL), no existing QPL has achieved full separation between the programmer-facing surface model and the underlying quantum substrate.
